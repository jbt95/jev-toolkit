...
Every call is logged to `~/.local/share/jev/events.jsonl` and exposed on the
`Jev Impact` dashboard (`jev meter serve`, port 8788). Delete this file and its
`instructions` entry to end the test.
